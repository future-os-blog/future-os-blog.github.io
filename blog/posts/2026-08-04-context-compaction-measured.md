...
[`compaction_experiment/`](https://github.com/futuregene/future-os/tree/main/scripts/compaction_experiment) in the FutureOS repo. The external
...
[`compaction/`](https://github.com/futuregene/future-os/tree/main/docs/internals/compaction); the figures are generated by
`sharing_figures.py` in the `compaction_experiment/` harness.
